                ...
                <div class="cnt">
                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <!-- End Carousel -->
                            <div class="post"><br />
                                 <h2><span>Farmer Welfare</span></h2>
                               <br />
                               <img alt=""  src="images/farmer_1.jpg" /><br /><br /><table><tr><td  height="20" colspan="2" style="background-color:pink"><font size="4">Features And Benefits:</font></td></tr></table>
                          
<ul>
    <li>Access a wide network of branches and over a thousand ATMs across the country to meet all your banking needs</li>
                            <li>Initial Pay-In & AQB requirement = Nil</li>
                            <li>Free Cash Deposit at ATM / Branch</li>
                            <li>One Branch Cash Withdrawal Transaction free per month</li>
                            <li>Free Balance Enquiry / Cheque Deposit / Mini Statement transactions on HDFC Bank ATMs</li>
                            <li>Use the Free National Electronic Funds Transfer (NEFT) facility to transfer funds from your HDFC Bank account to an account in another Bank at the locations as specified by RBI</li>
                            <li>Enjoy Free IVR based PhoneBanking. (Agent assisted calls will be charged*)</li>
                            <li>Free NetBanking , MobileBanking and PhoneBanking</li>
                            <li>Free Passbook facility available at home branch for account holders (individuals).</li>
                            <li>Free Monthly email statements .</li>
                            <li>First Cheque book consisting of 25 leaves free and subsequent cheque books to be charged at the rate of Rs 5/- per cheque leaf.</li>
                            <li>Free cash withdrawal transactions at any Bank ATMS through Debit Card.</li>
                            <li>International Debit Card available only on request at the branch @ Rs. 100/- p.a. (plus applicable taxes) for each applicant.</li>
                            </ul><br />
* Conditions Apply
<br /><br />
<p>Just fill the <a href="<%=request.getContextPath()%>/Pages/applyfarmerwel.jsp"> Online Application Form</a> and our representative will get in touch     with you shortly. </p>
