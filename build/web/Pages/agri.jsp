                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                ...
                                <h2><span>Agriculture </span>Banking</h2>
                                
                                <img alt="" width="700" src="images/agriculture.jpg" />
                                <br /><br />
                                <h3><span>Overview </span></h3>
                                <br />
                                <p align="justify">
                                    Royal Bank, as a leading Indian private sector bank, is fully committed to ensure that the benefits of world-class banking reach all sectors of the country, particularly in the rural areas and in the agriculture sector.
                                </p>
                                
                                <p align="justify">
                                    The bank provides need-based agricultural loans of varying tenors to all credit worthy clients engaged in farming of staple as well as cash crops, horticulture, plantations, poultry, animal husbandry, dairying, seeds, warehousing, etc. The bank also finances the supplies of a wide range of agri inputs like seeds, fertilisers, pesticides, micro nutrients and micro irrigation tools. The bank has identified transportation, storage and processing of food and other agri commodities as a thrust area and is offering working capital and term loans of varying tenors to eligible processors, based on not only their financials but also on the strengths of underlying commodities. In this manner, the bank facilitates the food chain from the "farm gate to the food plate". The bank is expanding its rural presence rapidly in order to deliver these products effectively at the doorsteps of their valued customers, at affordable prices.
                                </p>
                                <br />
                                <a href="farmerwel.jsp">click here</a>&nbsp;&nbsp;to get more information and apply for services.
                            </div>
