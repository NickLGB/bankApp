                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                             ...
                             <% String branch = request.getParameter("branch"); %>
                              ...
                              <br/><br/>
                              <h2>Fixed Deposit Details:</h2><br/><br/>
                                             <font size="2" color="Blue" >
                                                 Name: &nbsp;&nbsp; <% out.print(name1); %><br/><br/>
                                                 Address: &nbsp;&nbsp; <% out.print(add); %><br/><br/>
                                                 Branch: &nbsp;&nbsp; <% out.print(branch); %><br/><br/>
                                                 FD Type: &nbsp;&nbsp; <% out.print(type); %><br/><br/>
                                            </font><br/><br/>
                                            <table border="1" width="100%">
                                                     <tr>
                                                         <td height="40" align="center" bgcolor="rgb(198,217,241)">Deposited Amount</td>
                                                         <td height="40" align="center" bgcolor="rgb(198,217,241)">Start Date</td>
                                                         <td height="40" align="center" bgcolor="rgb(198,217,241)">Period</td>
                                                         <td height="40" align="center" bgcolor="rgb(198,217,241)">Rate</td>
                                                         <td height="40" align="center" bgcolor="rgb(198,217,241)">Total received</td>
                                                          </tr>
                                                     <tr>
                                                         <td height="30" align="center"><% out.print(dep); %></td>
                                                         <td height="30" align="center"><% out.print(date); %></td>
                                                         <td height="30" align="center"><% out.print(period); %>&nbsp;Months</td>
                                                         <td height="30" align="center">8.25%</td>
                                                         <td height="30" align="center"><% out.print(total); %></td>
                                                     </tr>
                                                 </table>

                                                     <br/>
                                                <center><a href="javascript:history.go(-1)"><img alt=""  src="images/back.gif" /></a></center><br/><br/>
                                                 <a href="/NewBank/services">click here </a> &nbsp; to access more services.
