...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
   ...
   xmlhttp.open("POST","/NewBank/recharge?q="+str,true);
    xmlhttp.send();
}
</script>
<script type="text/javascript">
            function validate(){
              var cusno=document.myform.cusno.value;
              var amount=document.myform.amount.value;
              var sertype=document.myform.sertype.value;

            
              if(selectCheck(sertype,"select service.")){
              if(isNum1(cusno,12,12,"Enter 12-digit number only.")){
                  if(isNum(amount,"Enter only digits in amount"))
                      return true;
              }}
                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                ...
                                <center><br/><br/>
                                    <font color="Blue">Select Category to recharge service.</font><br/><br/>
				<form action="">
				<select name="type" onclick="showCustomer(this.value)">
               <option value="" selected="selected">----Select----</option>
               <option value="DTH">DTH service Recharge</option>
