                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                ...
                                <% if(name1==null) name1="back"; %>

                              <br/><br/>
                                             <font size="2" color="Blue">
                                                 Welcome &nbsp;&nbsp;&nbsp; <% out.println(name1); %><br/>
                                                 <br/></font>
                                                 <br/>Select service from below:
                                                 <font size="3">
                                                 <ul>
                                                     <table width="100%">
                                                         <tr><td height="30"><li>&nbsp;&nbsp;&nbsp;<a href="transfer.jsp">Money Transfer</a> </li></td>
                                                             <td> <li>&nbsp;&nbsp;&nbsp;<a href="payment.jsp">Bill Payment</a> </li></td></tr>
                                                    <tr><td height="30"> <li>&nbsp;&nbsp;&nbsp;<a href="recharge.jsp">Recharge Payment</a> </li></td>
                                                             <td> <li>&nbsp;&nbsp;&nbsp;<a href="golden.jsp">Golden Card</a> </li></td></tr>
                                                    <tr><td height="30">   <li>&nbsp;&nbsp;&nbsp;<a href="applyFD.jsp">Apply Fixed Deposit</a> </li></td>
                                                             <td> <li>&nbsp;&nbsp;&nbsp;<a href="/NewBank/viewbalance">View Balance</a> </li></td></tr>
                                                    <tr><td height="30"><li>&nbsp;&nbsp;&nbsp;<a href="minibalance.jsp">View transactions</a> </li></td>
                                                        <td><li>&nbsp;&nbsp;&nbsp;<a href="chngPass.jsp">Change Password</a> </li></td></tr>
