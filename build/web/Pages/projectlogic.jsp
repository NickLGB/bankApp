                ...
                <div class="cnt">
                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                <br/>
                                <h2>create online account</h2><br/>
                                <p align="justify">No user can open online account directly. He should open his account personally in any of the Royal bank branch. After he got unique account number he is eligible to apply for online services provided by our bank.</p>
                                <br/><br/><p align="justify">&nbsp;&nbsp;&nbsp;User should provide their identity while registering for online services. As well as he should provide verification code which he will get from any of the Royal bank branch. Keep this code secret to avoid unauthorized usage of your account.</p>
                            <br/><br/>
                            <h2>Regarding account transaction</h2><br/>
                                <p align="justify">Any transaction done by user from their account cannot be undone in any situations. Therefore we request you that please fill details correctly so that we can help you better. </p>
                                <br/><br/><p align="justify">&nbsp;&nbsp;&nbsp;You can verify your balance and take a copy for your use which is completely valid as a bank statement for more information and any query visit our nearest branch or call customer care services 24hours. We are happy to provide you services   </p>
                                <br/><br/><p align="justify">&nbsp;&nbsp;&nbsp;Our customer care numbers are:</p><br/>
                                <ul>
                                    <li>+91-9967224033</li>
                                    <li>+91-9821853087</li>
                                    <li>+91-9821670389</li>
