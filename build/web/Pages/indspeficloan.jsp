                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <b><br /><font size="4" color="Blue">Industry Specific Loans </font></b><br /><br />
                                <br/>
                                <center><img height="150" width="350" alt=""  src="images/Industry-Solutions.jpg" /></center>
                                 <br/><br/>
                                     <p align="justify">Every industry has its own set of unique challenges and requirements. At ICICI Bank, we have designed industry-specific solutions. We offer dedicated teams for each industry group and products and services tailored to meet your industry's unique needs. </p>
                                 <br/>
                                <table cellpadding="5" cellspacing="10" width="100%">
                                 <tr>
                                <td rowspan="1">
                                    <h2><span>Construction </span></h2>
                                <p align="justify">Get customised end-to-end solutions.
                                </p>
                               </td>
                                 <td><h2><span>Educational</span> Institutions</h2>
                                <p align="justify">Rely on our experience for the development of your business
                                </p>
                                </td>
                                </tr>
                                <tr>
                                <td rowspan="1">
                                <h2><span>Pharmaceuticals</span></h2>
                                <p align="justify">Increase your awareness of the latest practices and challenges.
                                </p>
                                </td>
                                <td>
                               <h2><span>Information</span> Technology </h2>
                                <p align="justify">The Information Technology industry is expected to grow to double its current size by the year 2012.
                                </p>
                                </td>
                                </tr>
                                </table>
