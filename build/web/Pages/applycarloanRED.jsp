                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                              ...
                              <% String name2= request.getParameter("lastn"); %>
                             <% String title = request.getParameter("title"); %>
                             <% String ser = request.getParameter("ser"); %>

                                             <font size="2" color="Blue">
                                                 <% out.println(title+" "+name1+" "+name2); %><br/><br/>
                                                 <% out.println("Thank you for Regisring for our "+ser+" Insurance Schemes."); %><br/><br/>
                                                 <% out.println("We Will Send you Our Representive soon."); %><br/><br/>
                                                 <% out.println(""); %><br/></font>
