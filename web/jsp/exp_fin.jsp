                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                ...
                                <h2><span>Export</span> Finance</h2>
                                <br/>
                                <img alt=""  src="images/exp_finance.jpg" />
                                <br /><br />
                                <p align="justify">HSBC can provide export finance to meet your business needs. Because we take time to understand your business, you can rest assured that your facilities will be structured around the actual business you do, taking into account your unique requirements at different stages of your trade cycle.
                                </p>
                                <br />
                                <p align="justify">Our range of export financing options can help to accommodate any funding gaps in your trade cycle:
                                </p>
                                <br />
                                <p align="justify"><b>Pre-shipment finance</b> ? we can offer facilities such as packing credits or manufacturing advances aimed at easing your cash flow while you prepare to complete your shipment orders.
                                </p>
                                <br />
                                 <p align="justify"><b>Post-shipment finance </b> ?we may negotiate clean documents and pay the discounted value of the invoice concerned. No facilities are required, and funds will typically be advanced to you within 24 hours.
                                 </p>
                                <br />
                                <h2><span>Export Finance </span> Facilities</h2>
                                 <ul>
                                    <li>Pre-shipment Credit </li>
                                    <li>Post Shipment Credit </li>
                                    <li>Buyers' Credit </li>
                                    <li>Suppliers' Credit [including deferred payment credit] </li>
                                    <li>Bills Discounting </li>
                                    <li>Bills Discounting </li>
                                    <li>Warehousing Finance </li>
                                    <li>Export Lines of Credit (Non-recourse finance) </li>
                                </ul>
                            </div>
