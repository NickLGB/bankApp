                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                ...
                                <p><b>Board Members: </b></p><br /><br />

				<p><a href="<%=request.getContextPath()%>/Pages/kmpatil.jsp"><font color="Red">Hon. Mr. K.M.Patil, Chairman</font></a></p> <br />
				<p><a href="<%=request.getContextPath()%>/Pages/npwagh.jsp"><font color="Red">Hon. Mr. N.P.Wagh</font></a></p> <br />
				<p><a href="<%=request.getContextPath()%>/Pages/pkpujari.jsp"><font color="Red">Dr. P. K. Pujari</font></a></p> <br />
				<p><a href="<%=request.getContextPath()%>/Pages/mksharma.jsp"><font color="Red">Dr. M. K. Sharma</font></a></p> <br />
				<p><a href="<%=request.getContextPath()%>/Pages/neetakochar.jsp"><font color="Red">Ms.Neeta Kochar ,Executive Director & CEO</font></a></p> <br />
				<p><a href="<%=request.getContextPath()%>/Pages/rajkumar.jsp"><font color="Red">Mr. Raj Kumar ,Executive Director & CFO</font></a></p> <br />
				<p><a href="<%=request.getContextPath()%>/Pages/rajivsabraval.jsp"><font color="Red">Mr.Rajiv Sabraval, Executive Director</font></a></p> <br />
