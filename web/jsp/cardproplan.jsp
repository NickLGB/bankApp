                    ...
                    <div id="content">
                        ...
                        <div class="column2 middle-col">
                            ...
                            <div class="post">
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <p><b><br /><font size="4" color="Blue">Card Protection: </font></b></p><br /><br />
                                <img height="250" width="250" alt=""  src="images/cpp.jpg" />
                                 <br/><br/>
                                <h2><span>Card </span>Protection Plan</h2>
                                <p align="justify">CPP Card Protection Plan on Royal Bank Credit Cards is a 24 hour card protection service for use in the event of card loss, theft and related fraud. You can now protect all your important cards & valuable documents including all your credit, debit, ATM, membership or loyalty cards.
                                Plan starts at less than Rs. 3 per day. 
                                </p>
                                <br/>
                                <h2><span>Key Benefits of </span>Card Protection Plan:</h2>
                                <br/>
                                <h3>Fraud Protection</h3>
                                <br/>
                                <p align="justify">Your cards are protected against fraudulent use from 7 days prior to your loss report to CPP until your membership is valid.
Example: if you report yours cards as lost, on 10 January 2009, they will be protected from 7 days prior to this date.
</p>
                                <h3>Emergency Travel Assistance</h3>
                                <br/>
                                <p align="justify">CPP will facilitate through its authorized dealer an advance direct to your hotel to cover your hotel bill and also arrange travel tickets for a safe return home. The advance will be arranged within the limits mentioned in your membership cover. 
 </p>
                                <h3>Loss Reporting</h3>
                                <br/>
                                <p align="justify">No matter where you are, all it takes is a one free call to CPP 24 hour helpline to report card loss. CPP will call all your issuers and ask them to cancel the cards you reported as lost. Additionally we also assist you to get them replaced. </p>
                                <h3>Valuable Document Registration</h3>
                                <br/>
                                <p align="justify">You can register with CPP details of important and valuable documents like passport, driving license, insurance policies, etc for easy access, should you ever need these when the originals are not around or lost. CPP also helps you getting passport loss notified, when traveling abroad.</p>
                                <br/>
                                <h2><span> How to Protect Your </span>Cards</h2>
                               <p align="justify">After you avail of your CPP, call CPP's 24-hour helpline to register and protect all your cards - credit, debit, ATM, membership and loyalty cards (there is no limit to the number of cards that you can register on your policy) and even your passport, PAN card and driving license etc. This will help you block your cards quickly, if it's ever required.</p>
