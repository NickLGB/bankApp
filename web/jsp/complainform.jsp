...
if(isAlphabet(name,"Please Enter leters in Your name.")){
    ...
    if(isAlphabet(city,"Please Enter letters in city.")){
     if(isNumeric(conno,"Enter only 10digit number"))     {
       if(selectCheck(product,"Please select Product to complain.")){
                 if(isAlphanumeric(complain,"Enter letters and numbers in address")){
                            ...
                            <div class="post">
                                ...
                                <center>
                                    <table class="design5"  cellspacing='0'>
                                        ...
                                        <tr>
                                            <td>
                                                <form id="form" name="myform" action="/NewBank/complain" method="post">
                                                <table  class="Design5" cellspacing='0'>
                                                    <%
                                                   if(s.getAttribute("username")!=null){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><div id="textf">
                                                            <% out.print("<input type='text' name='mob1' value='"+mob+"' disabled=disabled class='field blink' />");
                                                             out.print("<input type='hidden' name='conno' value='"+mob+"'/>");
                                                               out.print("<input type='hidden' name='city' value='no' />");%> </div> </td></tr><%
                                                    ...
                                                    <tr>
                                                        <td align="right" height="30" width="50%"><font color="red">*</font>City:&nbsp;&nbsp;&nbsp;</td>
                                                        <td colspan="2"><div id="textf"><input type="text" name="city" class="field blink" /></div></td>
                                                    </tr>
                                                    <tr>
