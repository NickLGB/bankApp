...
String connectionURL = "jdbc:mysql://localhost:3306/bank";
        ...
        try {
            ...
            String queryString = "INSERT INTO complain(fullname,address,city,mob,product,complain,cusornot,acno) VALUES (?,?,?,?,?,?,?,?)";
            ...
            pstatement.setString(5, product);
             ...
             pstatement.setString(8, acno);
            pstatement.executeUpdate();

        msg="<br/>Your complain successfully registred.<br/><br/>we will take action soon.<br/>";
        }
